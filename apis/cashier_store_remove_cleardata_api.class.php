 ...
 * @author royalwang
 */
class cashier_store_remove_cleardata_api extends Component_Event_Api
{
    ...
    public function call(& $options)
    {
        ...
        if (empty($store_id)) {
            return new ecjia_error('invalid_parameter', sprintf(__('请求接口%s参数无效', 'cashier'), 'cashier_store_remove_cleardata_api'));
        }
