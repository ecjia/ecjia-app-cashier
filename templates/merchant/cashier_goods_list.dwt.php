					...
					<table class="table table-striped table-hover table-hide-edit ecjiaf-tlf">
						...
						<tbody>
							...
							<tr>
								...
								<td align="center">
									<i class="cursor_pointer fa {if $goods.is_on_sale}fa-check {else}fa-times{/if}" data-trigger="toggle_on_sale" data-url="{RC_Uri::url('cashier/mh_cashier_goods/toggle_on_sale')}" refresh-url="{RC_Uri::url('cashier/mh_cashier_goods/init')}" data-id="{$goods.goods_id}"></i>
								</td>
								<td align="center">
