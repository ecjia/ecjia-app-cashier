...
class StoreCashierScalesClear extends StoreCleanAbstract
{
     ...
     * @var string
     */
    protected $code = 'store_cashier_scales_clear';

    /**
     * 名称
     * @var string
     */
    protected $name = '店铺电子秤设备';
...
HTML;
    ...
    {
        $count = RC_DB::table('cashier_scales')->where('store_id', $this->store_id)->count();
    ...
    public function handleClean()
    {
        ...
        $result = RC_DB::table('cashier_scales')->where('store_id', $this->store_id)->delete();
    ...
    public function handleAdminLog()
    {
        ...
        ecjia_admin::admin_log($merchants_name, 'clean', 'store_cashier_scales');
    }
